"""Provides interface for technical analytics parameteres based on a pd.DataFrame"""

# TODO:
# Add Analysis for technical indicators
# Based on analytics add buy-signals if long-term-trends are established
# Based on analytics add sell-signals if long-term-trends are established
